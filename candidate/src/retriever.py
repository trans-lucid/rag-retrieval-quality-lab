...
def retrieve(query: str, *, tenant_id: str, user_id: str, limit: int = 4) -> dict[str, Any]:
    """Retrieve chunks for a tenant-scoped user query.

    The starter intentionally searches globally and relies on ranking after the
    fact. Candidates should move tenant and ACL constraints into the retrieval
    path and return only defensible citations.
    """
